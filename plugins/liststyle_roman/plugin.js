(function($) {
  /** ------------------------------------ COPIED FROM CKEDITOR GIT HUB  WITH listCommand modified to support list-style-type*/
	...
	function changeListType( editor, groupObj, database, listsCreated ) {
        ...
        // MODIFIED liststyle by OLIVER
        if (this.liststyle) {
          newListNode.setStyle( 'list-style-type', this.liststyle);
        }
    ...
    // MODIFIED liststyle by OLIVER
    if (this.liststyle) {
      listNode.setStyle( 'list-style-type', this.liststyle);
    }
	...
	function listCommand( name, type, liststyle ) {
		this.name = name;
		this.type = type;
		this.context = type;
  ...
  /** ------------------------------------ COPIED FROM CKEDITOR GIT HUB */
	CKEDITOR.plugins.add( 'liststyle_roman', {
		icons: 'liststyle_roman',
		init: function( editor ) {
			editor.addCommand( 'liststyle_roman', new listCommand( 'numberedlist', 'ol', 'lower-roman' ));

			editor.ui.addButton( 'liststyle_roman', {
				label: 'Insert Lower Roman',
				command: 'liststyle_roman',
        directional: true,
				toolbar: 'liststyle_roman'
			});
		}
	});
})(jQuery);
